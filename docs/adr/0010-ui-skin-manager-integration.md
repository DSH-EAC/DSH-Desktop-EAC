...
EAC rejects a snapshot with an unknown slot or asset outside the resolved inventory. It does not repeat package discovery, dependency resolution, user selection, health policy, previous-known-good retention, or rollback ordering.
