...
// recovery styles and never restores the removed EAC source tree. The host consumes
// whatever locally staged manager snapshot is available; source provenance is not a
// runtime contract.
